...
import school.sptech.democonexaoapiexterna.dto.QtdItensResponse;
...
public class ItemMockController {
    ...
    @GetMapping("/soma")
    public ResponseEntity<QtdItensResponse> somaQtdItens(@RequestParam String BuscaNome) {
        BancoMockDto[] respostaOrdenada = getBancoMockDtoArray();
        int qtdItens = Ordenacao.calcularQtdItem(respostaOrdenada, BuscaNome);
        QtdItensResponse response = new QtdItensResponse(qtdItens);
